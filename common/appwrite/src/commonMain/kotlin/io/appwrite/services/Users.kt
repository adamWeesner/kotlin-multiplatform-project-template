...
class Users : Service {
    ...
    suspend inline fun <reified T> list(
        ...
        val converter: (Any) -> UserList<T> = {
            UserList.from(map = it as Map<String, Any>, nestedType)
        }
        return client.call(
            "GET",
            path,
    ...
    @JvmOverloads
    @Throws(AppwriteException::class)
    suspend inline fun <reified T> createArgon2User(
        userId: String,
        email: String,
        password: String,
        name: String? = null,
    ...
    suspend fun createArgon2User(
        ...
        password: String,
        name: String? = null,
    ): User<Map<String, Any>> = createArgon2User(
        userId,
        email,
        password,
        name,
    ...
    @JvmOverloads
    @Throws(AppwriteException::class)
    suspend inline fun <reified T> createBcryptUser(
        userId: String,
        email: String,
        password: String,
        name: String? = null,
    ...
    suspend fun createBcryptUser(
        ...
        password: String,
        name: String? = null,
    ): User<Map<String, Any>> = createBcryptUser(
        userId,
        email,
        password,
        name,
    ...
    @JvmOverloads
    @Throws(AppwriteException::class)
    suspend inline fun <reified T> createMD5User(
        userId: String,
        email: String,
        password: String,
        name: String? = null,
    ...
    suspend fun createMD5User(
        ...
        password: String,
        name: String? = null,
    ): User<Map<String, Any>> = createMD5User(
        userId,
        email,
        password,
        name,
    ...
    @JvmOverloads
    @Throws(AppwriteException::class)
    suspend inline fun <reified T> createPHPassUser(
        userId: String,
        email: String,
        password: String,
        name: String? = null,
    ...
    suspend fun createPHPassUser(
        ...
        password: String,
        name: String? = null,
    ): User<Map<String, Any>> = createPHPassUser(
        userId,
        email,
        password,
        name,
    ...
    @JvmOverloads
    @Throws(AppwriteException::class)
    suspend inline fun <reified T> createScryptUser(
        userId: String,
        email: String,
        password: String,
        passwordSalt: String,
    ...
    suspend fun createScryptUser(
        ...
        passwordLength: Long,
        name: String? = null,
    ): User<Map<String, Any>> = createScryptUser(
        userId,
        email,
        password,
        passwordSalt,
    ...
    @JvmOverloads
    @Throws(AppwriteException::class)
    suspend inline fun <reified T> createScryptModifiedUser(
        userId: String,
        email: String,
        password: String,
        passwordSalt: String,
    ...
    suspend fun createScryptModifiedUser(
        ...
        passwordSignerKey: String,
        name: String? = null,
    ): User<Map<String, Any>> = createScryptModifiedUser(
        userId,
        email,
        password,
        passwordSalt,
    ...
    @JvmOverloads
    @Throws(AppwriteException::class)
    suspend inline fun <reified T> createSHAUser(
        userId: String,
        email: String,
        password: String,
    ...
    suspend fun createSHAUser(
        ...
        passwordVersion: String? = null,
        name: String? = null,
    ): User<Map<String, Any>> = createSHAUser(
        userId,
        email,
        password,
        passwordVersion,
     ...
     */
    @Throws(AppwriteException::class)
    suspend inline fun <reified T> updateEmailVerification(
        userId: String,
    ...
    suspend fun updateEmailVerification(
        userId: String,
        emailVerification: Boolean,
    ): User<Map<String, Any>> = updateEmailVerification(
        userId,
        emailVerification,
        nestedType = classOf(),
    )
     ...
     */
    @Throws(AppwriteException::class)
    suspend inline fun <reified T> updatePhoneVerification(
        userId: String,
    ...
    suspend fun updatePhoneVerification(
        userId: String,
        phoneVerification: Boolean,
    ): User<Map<String, Any>> = updatePhoneVerification(
        userId,
        phoneVerification,
        nestedType = classOf(),
    )
