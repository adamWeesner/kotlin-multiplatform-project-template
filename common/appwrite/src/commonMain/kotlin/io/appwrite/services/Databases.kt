...
class Databases(client: Client) : Service(client) {
    ...
    suspend fun list(
        ...
        val converter: (Any) -> DatabaseList = {
            DatabaseList.from(map = it as Map<String, Any>)
        }
        return client.call(
            "GET",
            path,
            headers,
            params,
            responseType = DatabaseList::class.java,
            converter,
        )
    }
    ...
    suspend fun create(
        ...
        val converter: (Any) -> Database = {
            Database.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = Database::class.java,
            converter,
        )
    }
    ...
    suspend fun listCollections(
        ...
        val converter: (Any) -> CollectionList = {
            CollectionList.from(map = it as Map<String, Any>)
        }
        return client.call(
            "GET",
            path,
            headers,
            params,
            responseType = CollectionList::class.java,
            converter,
        )
    }
    ...
    suspend fun listAttributes(
        ...
        val converter: (Any) -> AttributeList = {
            AttributeList.from(map = it as Map<String, Any>)
        }
        return client.call(
            "GET",
            path,
            headers,
            params,
            responseType = AttributeList::class.java,
            converter,
        )
    }
    ...
    suspend fun createBooleanAttribute(
        ...
        val converter: (Any) -> AttributeBoolean = {
            AttributeBoolean.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeBoolean::class.java,
            converter,
        )
    }
    ...
    suspend fun createDatetimeAttribute(
        ...
        val converter: (Any) -> AttributeDatetime = {
            AttributeDatetime.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeDatetime::class.java,
            converter,
        )
    }
    ...
    suspend fun createEmailAttribute(
        ...
        val converter: (Any) -> AttributeEmail = {
            AttributeEmail.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeEmail::class.java,
            converter,
        )
    }
    ...
    suspend fun createEnumAttribute(
        ...
        val converter: (Any) -> AttributeEnum = {
            AttributeEnum.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeEnum::class.java,
            converter,
        )
    }
    ...
    suspend fun createFloatAttribute(
        ...
        val converter: (Any) -> AttributeFloat = {
            AttributeFloat.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeFloat::class.java,
            converter,
        )
    }
    ...
    suspend fun createIntegerAttribute(
        ...
        val converter: (Any) -> AttributeInteger = {
            AttributeInteger.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeInteger::class.java,
            converter,
        )
    }
    ...
    suspend fun createIpAttribute(
        ...
        val converter: (Any) -> AttributeIp = {
            AttributeIp.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeIp::class.java,
            converter,
        )
    }
    ...
    suspend fun createRelationshipAttribute(
        ...
        val converter: (Any) -> AttributeRelationship = {
            AttributeRelationship.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeRelationship::class.java,
            converter,
        )
    }
    ...
    suspend fun createStringAttribute(
        ...
        val converter: (Any) -> AttributeString = {
            AttributeString.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeString::class.java,
            converter,
        )
    }
    ...
    suspend fun createUrlAttribute(
        ...
        val converter: (Any) -> AttributeUrl = {
            AttributeUrl.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
            headers,
            params,
            responseType = AttributeUrl::class.java,
            converter,
        )
    }
    ...
    suspend inline fun <reified T> listDocuments(
        ...
        val converter: (Any) -> DocumentList<T> = {
            DocumentList.from<T>(map = it as Map<String, Any>)
        }
        return client.call(
            "GET",
            path,
    ...
    suspend inline fun <reified T> createDocument(
        ...
        val converter: (Any) -> Document<T> = {
            Document.from<T>(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
    ...
    suspend fun listIndexes(
        ...
        val converter: (Any) -> IndexList = {
            IndexList.from(map = it as Map<String, Any>)
        }
        return client.call(
            "GET",
            path,
            headers,
            params,
            responseType = IndexList::class.java,
            converter,
        )
    }
    ...
    suspend fun createIndex(
        ...
        val converter: (Any) -> Index = {
            Index.from(map = it as Map<String, Any>)
        }
        return client.call(
            "POST",
            path,
